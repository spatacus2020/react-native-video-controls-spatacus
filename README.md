# react-native-video-controls-spatacus
### 更改了样式react-native-video-controls
...
Run `npm install --save react-native-video react-native-video-controls-spatacus`

Then run `react-native link react-native-video`

If you're using RN < 39 run `npm install --save react-native-video-controls-spatacus@1.0.1`. Note this version includes `react-native-video` as a normal dependency instead of a peer-dependency.
...
import VideoPlayer from 'react-native-video-controls-spatacus';
